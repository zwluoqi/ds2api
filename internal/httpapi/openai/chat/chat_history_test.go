...
func TestChatCompletionsCurrentInputFilePersistsNeutralPrompt(t *testing.T) {
	...
	if !strings.Contains(full.CurrentInputFile, "latest user turn") ||
		!strings.Contains(full.CurrentInputFile, "# DS2API_HISTORY.txt") ||
		!strings.Contains(full.CurrentInputFile, "=== 5. USER ===") {
